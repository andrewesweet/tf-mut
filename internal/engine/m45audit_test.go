...
func TestTheM45GateCoversEveryNamedRequirement(t *testing.T) {
	...
	required := map[string]string{
		...
		"real reports validate against 2.4.0":        "TestARealCharacterisationReportValidatesAgainstThePublishedSchema",
		...
		"a sensitive answer verifies, withheld":      "TestASensitiveAnswerIsVerifiedAndStillWithheld",
		...
		"a staged path cannot escape the sandbox":    "TestAStagedPathCannotEscapeTheSandbox",
		"a scaffold answer injects nothing":          "TestAScaffoldAnswerCannotInjectConfiguration",
		"a foreign registry is never replaced":       "TestAForeignRegistryIsNeverReplaced",
		...
		"real curate reports validate against 2.4.0": "TestARealCurateReportValidatesAgainstThePublishedSchema",
