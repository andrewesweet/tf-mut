...
# Run the M5a offline gates: the Tier 4 lifecycle witnesses, their classification
# pairs, the tier arithmetic, the matrix rows and the standard-report invariance proof.
gate-m5:
    mkdir -p "{{ artifact_dir }}/test"
